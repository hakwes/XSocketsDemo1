[T4Scaffolding.Scaffolder(Description = "Creates a new MessageInterceptor.")][CmdletBinding()]
param(        
...
Add-ProjectItemViaTemplate $outputPath -Template XHandshakeInterceptorTemplate `
	-Model @{ Namespace = $namespace; InterceptorName = $InterceptorName } `
	-SuccessMessage "Added XHandshakeInterceptor output at {0}" `
