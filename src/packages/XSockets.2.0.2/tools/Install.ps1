...
$PluginCatalogIsRelative = $xml.CreateElement('add')
$PluginCatalogIsRelative.setAttribute('key','XSockets.PluginCatalogIsRelative')
$PluginCatalogIsRelative.setAttribute('value','true')
$xml.configuration["appSettings"].AppendChild($PluginCatalogIsRelative)
