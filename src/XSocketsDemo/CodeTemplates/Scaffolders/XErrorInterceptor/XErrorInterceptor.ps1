[T4Scaffolding.Scaffolder(Description = "Creates a new ErrorInterceptor.")][CmdletBinding()]
param(        
...
Add-ProjectItemViaTemplate $outputPath -Template XErrorInterceptorTemplate `
	-Model @{ Namespace = $namespace; InterceptorName = $InterceptorName } `
	-SuccessMessage "Added XErrorInterceptor output at {0}" `
